...
const Hero: React.FC<HeroProps> = ({ emoji, greeting, largetext, description }) => {
  return (
    <section
      id='hero'
      ...
      <div className='flex flex-col md:flex-row lg:p-0 w-full'>
        ...
        <div className='relative -mt-10 sm:-mt-28 md:mt-0 md:flex-1 flex justify-center xl:justify-start w-full'>
          <div className='xl:pl-12 translate-y-1/4 xl:translate-x-1/4 grid w-2/3 lg:w-1/2 select-none'>
            <div
              className='relative scale-[0.7] -rotate-6 -left-1/4 -bottom-[10%] col-start-1 col-span-1 row-start-1 row-span-1 select-none'
            ...
            >
              <Image
                ...
                layout='fill'
                objectFit='contain'
                src='/card_front_min.png'
                alt='zauberer hamburg'
              />
            </div>

            <div
              className='relative rotate-6 scale-[0.8] -right-1/4 -bottom-[10%] col-start-1 col-span-1 row-start-1 row-span-1 select-none'
              /* style={{ rotate: 6, scale: 0.8 }}
              animate={{ opacity: [0, 1], y: [150, 0] }}
              transition={{ delay: 1 }} */
            >
