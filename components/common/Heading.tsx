...
const Heading: FC<HeadingProps> = ({ smallheading, heading, subheading, theme = 'primary' }) => {
    ...
    <>
      {colorFilter && (
        <div className='py-8 max-w-md lg:max-w-7xl'>
          <h2 className={`text-base font-medium ${theme && colorFilter[0]} tracking-wide`}>{smallheading}</h2>
